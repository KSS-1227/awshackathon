...
Several of the entity types are finance-specific. Extract them as follows:
- VENDOR: a company or individual that supplies goods or services (e.g. "Tata Consultancy Services")
- INVOICE: a billing document with an invoice number (e.g. "Invoice #INV-2024-047")
- INVOICE_AMOUNT: the total amount billed in an invoice (e.g. "₹80,000", "$5,200")
- CONTRACT_AMOUNT: the agreed amount in a contract or agreement (e.g. "₹50,000 per month")
